...
class OperationOption extends Component {
  ...
  render() {
    ...
    const optionList = [
      ...
      {visible: 'project', name: '导入数据', icon: <CreateNewFolder/>, onClick: ()=>this.handleImport('delete')},
      {visible: 'project', name: '导出数据', icon: <CreateNewFolder/>, onClick: ()=>this.handleExport('delete')},
      ...
      {visible: 'category', name: '导入数据', icon: <CreateNewFolder/>, onClick: ()=>this.handleImport('delete')},
      {visible: 'category', name: '导出数据', icon: <CreateNewFolder/>, onClick: ()=>this.handleExport('delete')},
